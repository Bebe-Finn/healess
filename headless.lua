...
getgenv().gagConfig = {
    ...
    PLANT_EGGS = { "Gem Egg", "Spooky Egg", "Enchanted Egg", "Bug Egg",},
    ...
    KEEP_PETS = {
        ["Emerald Snake"] = 5, ["Goat"] = 5, ["Magpie"] = 10, ["Pack Mule"] = 5, "Chimera", "Bearded Dragon", "Goblin Miner", 
    ...
    --EQUIP_PETS = { {"Starfish", 8, 1}, {"Petal Bee", 8, 2}, {"Honey Bee", 8, 3},{"Bee", 8, 4} },
